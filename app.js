...
const days = [
  ...
  { date: '10.04', title: '乍都乍周末集市与唐人街', city: '曼谷', stops: [
    ...
    ['15:00', '外围打卡', '水门寺外围公共拍照点：796 Soi Thoet Thai 26（不进寺）', 'paknamOuter'],
    ['16:30', '河岸拍照', 'Wat Arun 对岸 Tha Tien 公共观景点', 'watArunView'],
  ...
  { date: '10.05', title: '第四天：天气二选一', city: '曼谷', stops: [
    ...
    ['13:30', '海鲜备选', 'A Keen House Somsak Poo Op（天气不好方案顺路时安排）', 'keenHouseSomsak'],
